...
var spotImageMap = {
    ...
    // 台北机位图片（机位探索/机位采集数据）
    '虎山亲山步道': '机位采集数据/虎山亲山步道.png',
    '机车瀑布': '机位采集数据/机车瀑布.png',
    '老地方观景平台': '机位采集数据/老地方观景平台.png',
    '市区观景平台': '机位采集数据/市区观景平台.png',
    '台北忠孝橋': '机位采集数据/台北忠孝橋.png',
    '陶朱隐园': '机位采集数据/陶朱隐园.png',
    '象山': '机位采集数据/象山.png',
    '竹村居酒屋': '机位采集数据/竹村居酒屋.png',
    '福州山': '机位采集数据/福州山.png',
    '滨海果菜市场': '机位采集数据/滨海果菜市场.jpg'
};
...
var taipeiConfig = {
    name: '台北机位导航',
    center: useWGS84Coordinates(25.033968, 121.564468), // 台北101（WGS84）
    zoom: 16
};
...
var taipeiSpotData = [
    {
        ...
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0262307, 121.5675021),
        price: '消费入内',
        description: '信义区附近日式居酒屋氛围机位，适合街拍与人文纪实',
        facilities: ['餐饮', '室内外座位'],
        restrictions: ['请勿影响店家经营', '建议征得同意再拍摄'],
        rating: 4.4,
        environment: 'mixed',
        weather: ['sunny', 'cloudy', 'rainy'],
        bestTime: '傍晚-夜晚',
        address: '台北市（以导航为准）',
        imagePath: spotImageMap['竹村居酒屋'],
        shootingType: '创意',
        environmentType: '室内/室外',
        focalLength: '广角/标准',
        tripodRequired: '否',
        nearbyMetro: '',
        shootingTips: '建议使用大光圈和较高ISO，保留氛围灯光；注意不要拍到他人隐私。'
    },
    {
        id: 'taipei_002',
        name: '市区观景平台',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0813667,121.5272005), // 剑潭山观景台取点
        price: '免费',
        description: '剑潭山观景台视野，适合拍摄台北市区景观与日落夜景',
        facilities: ['步道', '观景点'],
        restrictions: ['注意安全', '夜间留意路况'],
        rating: 4.7,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '日落-蓝调-夜景',
        address: '台北市士林区剑潭山附近（以导航为准）',
        imagePath: spotImageMap['市区观景平台'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '广角/中长焦',
        tripodRequired: '建议（夜景长曝光）',
        nearbyMetro: '',
        shootingTips: '建议携带脚架与长焦；蓝调时刻亮灯更出片。'
    },
    {
        id: 'taipei_003',
        name: '老地方观景平台',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0904311, 121.5367826),
        price: '免费',
        description: '知名城市观景点，可远眺市区与天际线，适合黄昏与夜景',
        facilities: ['步道', '观景平台'],
        restrictions: ['注意安全', '高峰期人多需耐心等位'],
        rating: 4.8,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '日落-蓝调-夜景',
        address: '台北市士林区（以导航为准）',
        imagePath: spotImageMap['老地方观景平台'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '广角/中长焦',
        tripodRequired: '建议（夜景长曝光）',
        nearbyMetro: '',
        shootingTips: '建议提前到达抢占栏杆位；夜景可拍车流光轨。'
    },
    {
        id: 'taipei_004',
        name: '象山',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.027293, 121.5758387),
        price: '免费',
        description: '台北经典机位，视野可拍台北101与城市天际线',
        facilities: ['步道', '观景点'],
        restrictions: ['需要爬山', '注意防滑'],
        rating: 4.9,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '日落-蓝调-夜景',
        address: '台北市信义区象山步道（以导航为准）',
        imagePath: spotImageMap['象山'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '中长焦/长焦',
        tripodRequired: '建议（夜景长曝光）',
        nearbyMetro: '象山站',
        shootingTips: '台北101亮灯后更好看；建议中长焦压缩城市层次。'
    },
    {
        id: 'taipei_005',
        name: '台北忠孝橋',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0490727, 121.5063822),
        price: '免费',
        description: '忠孝桥人行步道机位：走上去后回头看，拉近镜头可拍出城市线条感',
        facilities: ['人行步道', '桥梁'],
        restrictions: ['注意车流与安全', '勿占用通行空间'],
        rating: 4.6,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '清晨/傍晚（能见度高时更佳）',
        address: '台北市玉泉公园旁（忠孝西路二段 & 环河北路口附近）',
        imagePath: spotImageMap['台北忠孝橋'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '中长焦',
        tripodRequired: '否',
        nearbyMetro: '',
        shootingTips: '需要天气好、能见度高；建议使用中长焦压缩透视，注意安全勿靠近车道。'
    },
    {
        id: 'taipei_006',
        name: '陶朱隐园',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0390499, 121.5712912),
        price: '免费',
        description: '台北特色建筑机位，旋转造型辨识度高，适合建筑摄影',
        facilities: ['建筑外观', '城市街景'],
        restrictions: ['注意车流', '勿影响行人通行'],
        rating: 4.5,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '白天/黄昏',
        address: '台北市信义区（以导航为准）',
        imagePath: spotImageMap['陶朱隐园'],
        shootingType: '建筑',
        environmentType: '室外',
        focalLength: '广角/中长焦',
        tripodRequired: '否',
        nearbyMetro: '',
        shootingTips: '可用广角贴近强调建筑曲线；或用中长焦做极简构图。'
    },
    {
        id: 'taipei_007',
        name: '机车瀑布',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.062801, 121.511369),
        price: '免费',
        description: '经典“机车瀑布”机位：路口高密度机车起步场面，画面冲击力强',
        facilities: ['路口天桥/路边视角'],
        restrictions: ['注意交通安全', '不要站到车道上'],
        rating: 4.7,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '早高峰 7:00-8:30（机车密度最大）',
        address: '捷运大桥头站1或1A口步行约5分钟（民权西路与延平北路二段交叉口附近）',
        imagePath: spotImageMap['机车瀑布'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '中长焦/长焦',
        tripodRequired: '否',
        nearbyMetro: '大桥头站',
        shootingTips: '建议使用较快快门定格车流或用慢门拉丝；留意自身位置安全。'
    },
    {
        id: 'taipei_008',
        name: '福州山',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0160102, 121.55484),
        price: '免费',
        description: '福州山公园周边观景机位，适合拍摄台北市景与远处天际线',
        facilities: ['步道', '公园'],
        restrictions: ['需要爬坡', '注意防蚊'],
        rating: 4.6,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '日落-蓝调-夜景',
        address: '台北市大安区福州山公园（以导航为准）',
        imagePath: spotImageMap['福州山'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '广角/中长焦',
        tripodRequired: '建议（夜景长曝光）',
        nearbyMetro: '',
        shootingTips: '建议带脚架；雨后天晴能见度更好。'
    },
    {
        id: 'taipei_009',
        name: '虎山亲山步道',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0320167, 121.5874881),
        price: '免费',
        description: '虎山亲山步道机位，适合拍摄台北101与城市景观',
        facilities: ['步道', '观景点'],
        restrictions: ['需要爬山', '注意防滑'],
        rating: 4.7,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '日落-蓝调-夜景',
        address: '台北市信义区虎山亲山步道（以导航为准）',
        imagePath: spotImageMap['虎山亲山步道'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '中长焦/长焦',
        tripodRequired: '建议（夜景长曝光）',
        nearbyMetro: '',
        shootingTips: '可用树叶/山体做前景构图；夜景注意脚架稳定。'
    },
    {
        id: 'taipei_010',
        name: '滨海果菜市场',
        type: 'photo',
        status: 'available',
        coordinates: useWGS84Coordinates(25.0675067, 121.5369514),
        price: '免费',
        description: '滨海果菜市场附近机位，可拍摄飞机进近与城市建筑同框的画面。',
        facilities: ['市场', '停车位附近', '城市道路'],
        restrictions: ['注意交通安全', '避免影响市场作业'],
        rating: 4.5,
        environment: 'outdoor',
        weather: ['sunny', 'cloudy'],
        bestTime: '白天天气好、航班较多时段',
        address: '台北市滨海果菜市场附近（以导航为准）',
        imagePath: spotImageMap['滨海果菜市场'],
        shootingType: '城市风光',
        environmentType: '室外',
        focalLength: '中长焦/长焦',
        tripodRequired: '否',
        nearbyMetro: '',
        shootingTips: '建议使用中长焦压缩远处建筑与飞机，提前查好航班时间，拍摄时关注自身与周边车辆安全。'
    },
    // 常用生活/通勤点位（自定义家与常逛地）
    {
        id: 'taipei_home_001',
        ...
        displayName: '🏠 家',
        type: 'poi',
        category: 'home', // 台北模式下作为“家”特殊标记
        status: 'available',
        coordinates: useWGS84Coordinates(25.053518, 121.507664),
        price: '—',
        description: '日常出发点（家）。',
        facilities: [],
        restrictions: [],
    ...
    },
    {
        ...
        displayName: '常逛 · 迪化街',
        type: 'poi',
        category: 'favorite', // 常逛地点
        status: 'available',
        coordinates: useWGS84Coordinates(25.053851, 121.510185),
        price: '—',
        description: '迪化街常逛区域，老街与市集氛围浓厚。',
        facilities: ['老街', '市集'],
        restrictions: [],
        rating: 5.0,
        environment: 'outdoor',
    ...
    },
    {
        ...
        category: 'favorite',
        status: 'available',
        coordinates: useWGS84Coordinates(25.054295, 121.514790),
        price: '—',
        description: '宁夏夜市常逛区域，小吃与街拍好去处。',
        facilities: ['夜市'],
        restrictions: [],
        rating: 5.0,
        environment: 'outdoor',
    ...
    },
    {
        id: 'taipei_fav_004',
        name: '台北地下街Y27',
        displayName: '常逛 · 台北地下街Y27',
        type: 'poi',
        category: 'favorite',
        status: 'available',
        coordinates: useWGS84Coordinates(25.050255, 121.510670),
        price: '—',
        description: '台北地下街 Y27 出入口附近，常用通道。',
        facilities: ['地下街', '出入口'],
        restrictions: [],
        rating: 5.0,
        environment: 'mixed',
